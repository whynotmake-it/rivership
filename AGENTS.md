...
- The GitHub Pages deploy builds `apps/example` for web (`.github/workflows/deploy.yaml`: `cd apps/example && flutter build web --release --wasm`); run the same command to check the aggregate example.

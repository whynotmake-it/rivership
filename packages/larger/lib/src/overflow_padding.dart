...
/// However, the hitbox will remain the same size as the [OverflowPadding]
...
class OverflowPadding extends SingleChildRenderObjectWidget {
  ...
  const OverflowPadding({required this.padding, super.child, super.key});
  ...
  void updateRenderObject(
    ...
    RenderOverflowPadding renderObject,
  ) {
    renderObject
      ..padding = padding
      ..textDirection = Directionality.maybeOf(context);

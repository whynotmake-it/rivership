...
import 'package:motor_example/velocity_tracking.dart';
...
final motorRoutes = [
  ...
  NamedRouteDef(
    name: VelocityTrackingExample.name,
    path: VelocityTrackingExample.path,
    type: RouteType.cupertino(),
    builder: (context, state) => const VelocityTrackingExample(),
  ),
  NamedRouteDef(

...
void main() {
  group('TrackController', () {
    ...
    group('looping', () {
      ...
      testWidgets('looping does not accumulate timing drift over many cycles',
          (tester) async {
        controller = TrackController(vsync: tester);
  ...
  group('initial value resolution', () {
    ...
    testWidgets('throws when there is no value to infer from', (tester) async {
      controller = TrackController(vsync: tester);
    ...
    testWidgets('throws when reading a track that never had a value',
        (tester) async {
      controller = TrackController(vsync: tester);
      final track = Track<double>(MotionConverter.single);

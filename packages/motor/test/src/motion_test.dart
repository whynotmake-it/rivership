  ...
  group('TrimmedMotion', () {
    ...
    group('simulation behavior', () {
      ...
      test('works with no trimming', () {
        ...
        final simulation = trimmed.createSimulation(start: 5, end: 15);

        // Should behave exactly like the original curve
        expect(simulation.x(0), closeTo(5, 1e-10));
        expect(simulation.x(0.5), closeTo(15, 1e-10));
        expect(simulation.isDone(0.5), isTrue);
      });
